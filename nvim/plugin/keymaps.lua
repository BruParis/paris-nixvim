...
local resize = require('user.resize')
keymap.set('n', '<C-Right>', function()
  resize.resize(0, 2, 'right')
end, { silent = true, desc = 'resize window right' })
keymap.set('n', '<C-Left>', function()
  resize.resize(0, 2, 'left')
end, { silent = true, desc = 'resize window left' })
keymap.set('n', '<C-Up>', function()
  resize.resize(0, 2, 'up')
end, { silent = true, desc = 'resize window up' })
keymap.set('n', '<C-Down>', function()
  resize.resize(0, 2, 'down')
end, { silent = true, desc = 'resize window down' })
